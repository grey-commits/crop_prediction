...
import { ThemeToggle } from "../components/theme-toggle"; // Ensure this exists
  ...
  return (
    <Fragment>
      ...
      <div className="w-full bg-white dark:bg-gray-900 border-b shadow-sm">
        <nav className="max-w-7xl mx-auto flex flex-wrap justify-between items-center py-4 px-4">
          <h2 className="text-xl font-bold text-primary">Predict-O-Crop</h2>
          <div className="flex flex-wrap gap-4 items-center">
            <Link to="/" className="text-sm font-medium hover:underline">Home</Link>
            <Link to="/soil-sampling" className="text-sm font-medium hover:underline">Soil Sampling</Link>
            <Link to="/analysis" className="text-sm font-medium hover:underline">Analysis</Link>
